...
export function ArgoProvider({ children }: { children: ReactNode }) {
  ...
  const [chats, setChats] = useState<Chat[]>([
    ...
    { id: 'general-production', name: 'Production', spaceId: MY_SPACE_ID, messages: [{ id: 'gprod-1', role: 'user' as const, content: 'This is the production environment.', timestamp: new Date('2025-03-20') }], createdAt: new Date('2025-03-20') },
  ...
  const [artifacts, setArtifacts] = useState<Artifact[]>([
    ...
    { id: 'demo-12', name: 'Mitigation Strategy – Databricks', spaceId: 'space-3', chatId: 'chat-3d', agentId: 'general', agentName: 'General Agent', capability: 'General Assistance', artifactType: 'markdown', toolsUsed: ['Knowledge Retrieval', 'Structured Artifact Generator'], timestamp: new Date('2025-03-12T10:10:00'), version: 3, fileSize: '7.8 KB',
      versions: [
