...
export function ArgoProvider({ children }: { children: ReactNode }) {
  ...
  const [chats, setChats] = useState<Chat[]>([
    ...
    { id: 'general-sandbox', name: 'Production', spaceId: MY_SPACE_ID, messages: [{ id: 'gsb-1', role: 'user' as const, content: 'This is the production environment.', timestamp: new Date('2025-03-20') }], createdAt: new Date('2025-03-20') },
